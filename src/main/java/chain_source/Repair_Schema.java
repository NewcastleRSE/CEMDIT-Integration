...
/**
 * 
 * Responsible for taking in ArrayList of Match_Struc objects and going through
 * each one and creating a repaired schema based on the relation between the
...
public class Repair_Schema {
	...
	public static void main(String[] args) {
		...
		// Calls spsm with source and target schemas (as a test harness) and then
		// performs the repair
	...
	/**
	 * 
	 * Take in the ArrayList of objects and start processing the repaired schema for
	...
	/**
	 * Creates a tree structure of the schema and adds that as a field to the
	 * Match_Struc object based on the relation between source and target schemas
	 * 
	...
	/**
	 * Using relation concept data, modify the tree to make sure that there are only
	 * links to parts of the schema that we think there is a match and return this *
	 * 
	 * @param root
	 * @param concept
	 * 
